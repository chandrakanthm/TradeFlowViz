...
var raycaster = new THREEE.Raycaster();
var vizilines, effect;
//intersect();
var mouse = new THREEE.Vector2();
...
function initScene() {
    ...
    var shaderMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: "varying vec3 vNormal;" + "varying vec2 vUv;" + "void main() {" + "gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0);" + "vNormal = normalize( normalMatrix * normal );" + "vUv = uv;" + "}",
        fragmentShader: "uniform sampler2D mapIndex;" +
    ...
    material.map = THREE.ImageUtils.loadTexture('images/map_indexed.png')
...
function render() {
    ...
    effect = new THREEE.StereoEffect(renderer);
...
function intersect() {
    ...
    var intersects = raycaster.intersectObjects(visualizationMesh.children, true);
